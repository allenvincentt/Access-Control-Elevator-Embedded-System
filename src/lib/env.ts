...
export const ELEVATOR_DEVICE_NAME = 'ElevatorTerminal';
export const ELEVATOR_DEVICE_KEY = rawElevatorKey;
export const IS_ELEVATOR_CONFIGURED = ELEVATOR_DEVICE_KEY.length > 0;
export const ELEVATOR_CONFIG_ERROR = IS_ELEVATOR_CONFIGURED
  ? null
  : 'EXPO_PUBLIC_ELEVATOR_KEY is not set. Set it to the ESP32 device key, then restart with "npx expo start --clear".';
